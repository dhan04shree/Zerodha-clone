function Hero() {
    return ( 
        <div className="container pt-5">
            ...
            <div className="row text-center py-5">
                <div className="col-md-4 py-4 pe-4">
                    <img src="images/pricingEquity.svg" alt="" style={{width:"70%"}}/>
                ...
                <img src="images/intradayTrades.svg" alt="" style={{width:"70%"}} />
                ...
                <div className="col-md-4 py-4 ps-4">
                <img src="images/pricingEquity.svg" alt="" style={{width:"70%"}} />
